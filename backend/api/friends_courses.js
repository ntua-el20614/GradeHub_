...
const fetchData = (student_id, friend_id, callback) => {
    ...
    pool.getConnection((err, connection) => {
        ...
        // Execute a SQL query to fetch data with privacy status
        const query = `
    SELECT course.name, course.course_id, course.semester, student.privacy
    FROM course
    ...
    WHERE subject_user.student_id = ${student_id} AND student.privacy=1
